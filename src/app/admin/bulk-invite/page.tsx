...
import { bulkInviteEmployees, checkExistingEmails, type BulkInviteResult } from "./actions";
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						{currentUser?.role === "admin" && (
							<div className="space-y-2">
								<Label htmlFor="role-select">Default Role for Invited Employees</Label>
								...
								<p className="text-xs text-muted-foreground">
									All invited employees will be assigned this role.
								</p>
							</div>
						)}
						...
						{currentUser?.role === "hr" && (
							<div className="rounded-lg bg-muted p-3">
								<p className="text-sm text-muted-foreground">
									As an HR user, you can only invite employees with the <Badge variant="outline">Employee</Badge> role.
								</p>
							</div>
						)}
					</CardContent>
